...
marks
km1 = kmeans(marks, center=2)#eculadian distance is calculated
km1
...
data = iris[, -5] # without known classification , removed the 
data
...
clusplot(data, iriskm1$cluster, color=T, shade=T, labels=3, lines=0)
