...
#if we increase the sales by one unit prmotion increases by 3.613
#sales Quantity=5837 -53*price+36*promotion
#residual error is equal to actual - 
names(summary(fit2))
...
#Assumptions
par(mfrow=c(2,2))#divide the ploting area into 4 parts
plot(fit2)
par(mfrow=c(1,1))#reverting back the changes
