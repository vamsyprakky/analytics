...
itemFrequencyPlot(Groceries, topN = 10, type='relative')# relative to total number of transactions
abline(h=0.15)
...
rules3 = apriori (data=Groceries, parameter=list (supp=0.002,conf = 0.8), appearance = list (default="lhs",rhs="whole milk"), control = list (verbose=F))#verbose will be resposible for display of timings
inspect(rules3[1:5])
inspect(rules3)
aprior
